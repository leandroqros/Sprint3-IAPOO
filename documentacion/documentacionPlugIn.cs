...
namespace documentacion
{
    ...
    [HelpFileBuilderPlugInExport("documentacion", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "documentacion plug-in")]
    public sealed class documentacionPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In documentacionPlugIn Execute() method");
        }
        #endregion
